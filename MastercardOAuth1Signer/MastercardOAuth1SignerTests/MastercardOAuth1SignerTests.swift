//
//  MastercardOAuth1SignerTests.swift
//  MastercardOAuth1SignerTests
//
//  Created by  Piyush Hirpara on 20/02/2019.
...
class MastercardOAuth1SignerTests: XCTestCase {
    ...
    func testLowercasedBaseUrl_ShouldRemoveRedundantPorts()
    {
        ...
        var baseURL = URL.init(string: encodedString!)?.lowercasedBaseUrl()
